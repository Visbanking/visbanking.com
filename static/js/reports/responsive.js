const interval = setInterval(() => {
	let tables = document.querySelectorAll("div.datatables"), tablesOverflowSetCount = 0;
	let charts = document.querySelectorAll("div.highcharts-container"), chartsOverflowSetCount = 0;
