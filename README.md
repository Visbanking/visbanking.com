...
Follow the links below to quickly access any code (and code-related) file or folder in the project. ***Note: not all project files are visible on the repository. Some have been excluded for security and/or performance reasons.***
...
- [views](./views/)
	- [admin](./views/admin/)
		- [dashboard](./views/admin/dashboard/)
			- [content](./views/admin/dashboard/content/)
				- [insights](./views/admin/dashboard/content/insights/)
					- [create.pug](./views/admin/dashboard/content/insights/create.pug)
					- [edit.pug](./views/admin/dashboard/content/insights/edit.pug)
	...
	- [emails](./views/emails/)
		...
		- [conversionLeadSubmission.pug](./views/emails/conversionLeadSubmission.pug)
	...
	- [landing](./views/landing/)
		...
		- [report.pug](./views/landing/report.pug)
...
- [tests](./tests/)
	- [models](./tests/models/)
		...
		- [contact.model.test.js](./tests/models/contact.model.test.js)
		- [faq.model.test.js](./tests/models/faq.model.test.js)
- [static](./static/)
	- [css](./static/css/)
		- [admin](./static/css/admin/)
			- [dashboard](./static/css/admin/dashboard/)
				- [content](./static/css/admin/dashboard/content/)
					- [insights](./static/css/admin/dashboard/content/insights/)
						- [create.css](./static/css/admin/dashboard/content/insights/create.css)
		...
		- [landing](./static/css/landing/)
			...
			- [report.css](./static/css/landing/report.css)
	...
	- [js](./static/js/)
		- [admin](./static/js/admin/)
			- [dashboard](./static/js/admin/dashboard/)
				- [content](./static/js/admin/dashboard/content/)
					- [insights](./static/js/admin/dashboard/content/insights/)
						- [create.js](./static/js/admin/dashboard/content/insights/create.js)
						- [edit.js](./static/js/admin/dashboard/content/insights/edit.js)
						- [editor.js](./static/js/admin/dashboard/content/insights/editor.js)
				- [company.js](./static/js/admin/dashboard/company.js)
				- [content.js](./static/js/admin/dashboard/content.js)
				- [system.js](./static/js/admin/dashboard/system.js)
				- [users.js](./static/js/admin/dashboard/users.js)
	...
	- [videos](./static/videos/)
		- [index](./static/videos/index/)
			- [platform.mp4](./static/videos/index/platform.mp4)
		- [landing](./static/videos/landing/)
			- [news-digest.mp4](./static/videos/landing/news-digest.mp4)
		- [services.mp4](./static/videos/services.mp4)
- [routing](./routing/)
	- [admin](./routing/admin/)
		- [dashboard](./routing/admin/dashboard/)
			- [content](./routing/admin/dashboard/content/)
				- [insights.js](./routing/admin/dashboard/content/insights.js)
				- [faqs.js](./routing/admin/dashboard/content/faqs.js)
			- [company](./routing/admin/dashboard/company/)
				- [members.js](./routing/admin/dashboard/company/members.js)
			- [system](./routing/admin/dashboard/system/)
				- [profile.js](./routing/admin/dashboard/system/profile.js)
				- [admins.js](./routing/admin/dashboard/system/admins.js)
				- [status.js](./routing/admin/dashboard/system/status.js)
			- [users](./routing/admin/dashboard/users/)
				- [academics.js](./routing/admin/dashboard/users/academics.js)
			- [company.js](./routing/admin/dashboard/company.js)
			- [content.js](./static/js/admin/dashboard/content.js)
			- [system.js](./static/js/admin/dashboard/system.js)
			- [users.js](./static/js/admin/dashboard/users.js)
		- [dashboard.js](./routing/admin/dashboard.js)
		- [login.js](./routing/admin/login.js)
		- [logout.js](./routing/admin/logout.js)
	- [api](./routing/api/)
		- [admins.js](./routing/api/admins.js)
		- [insights.js](./routing/api/insights.js)
	- [landing](./routing/landing/)
		- [academic.js](./routing/landing/academic.js)
		- [newsDigest.js](./routing/landing/newsDigest.js)
		- [report.js](./routing/landing/report.js)
	- [about.js](./routing/about.js)
	- [admin.js](./routing/admin.js)
	- [api.js](./routing/api.js)
...
- [models](./models/)
	...
	- [conversionLead.model.js](./models/conversionLead.model.js)
...
- [data](./data/)
	...
	- [expressStatusMonitor.js](./data/expressStatusMonitor.js)
...
- [controllers](./controllers/)
	...
	- [conversionLead.controller.js](./controllers/conversionLead.controller.js)
