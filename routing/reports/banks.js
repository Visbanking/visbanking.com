...
router.get("/", (req, res) => {
    if (!req.query.state && !req.query.city && !req.query.status && !req.query.bankName) {
        ...
        if (bankName && state && city && status) res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}?status=${status}&bankName=${bankName}`);
        else if (bankName && state && city) res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}?bankName=${bankName}`);
        else if (bankName && state && status) res.redirect(`/reports/bank/${toUpper(state)}?status=${status}&bankName=${bankName}`);
        else if (state && city && status) res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}?status=${status}`);
        else if (bankName && state) res.redirect(`/reports/bank/${toUpper(state)}?bankName=${bankName}`);
        else if (state && city) res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}`);
...
router.get("/:state_abbreviation/:city_name", (req, res) => {
    ...
    if (state !== toUpper(state) || city !== city.split(" ").map(word => capitalize(word)).join(" ")) return res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}`);
...
router.get("/:state_abbreviation/:city_name/:bank_id", (req, res) => {
    ...
    if (state !== toUpper(state) || city !== city.split(" ").map(word => capitalize(word)).join(" ")) return res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}/${bank}`);
...
router.get("/:state_abbreviation/:city_name/:bank_id/:report_page_name", (req, res) => {
    ...
    if (state !== toUpper(state) || city !== city.split(" ").map(word => capitalize(word)).join(" ")) return res.redirect(`/reports/bank/${toUpper(state)}/${city.split(" ").map(word => capitalize(word)).join(" ")}/${bank}/${page}`);
